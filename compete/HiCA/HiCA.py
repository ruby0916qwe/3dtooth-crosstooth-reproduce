...
class HiCANet(nn.Module):
    def __init__(self, k=16, in_channels=12, output_channels=15, return_feature=False, name=None):
        ...
        self.pred_edge_fin4 = nn.Sequential(nn.Conv1d(128, 2, kernel_size=1, bias=False))
