...
from compete.ToothGroupNet.basic_operators import *
import re
...
class PointTransformerLayer(nn.Module):
    ...
    def forward(self, pxo) -> torch.Tensor:
        ...
        x_k, _ = pointops.queryandgroup(self.nsample, p, p, x_k, None, o, o, use_xyz=True)  # (n, nsample, 3+c)
        x_v, _ = pointops.queryandgroup(self.nsample, p, p, x_v, None, o, o, use_xyz=False)  # (n, nsample, c)
