...
class ToothData(Dataset):
    def __init__(self, args, file_list, with_label=True, augment=False):
        """
        ...
        self.point_transform_norm = transforms.Compose([
            data_util.PointcloudToTensor(),
            data_util.PointcloudNormalize(radius=1)
        ])

        self.point_transform_aug = transforms.Compose([
    ...
    def __getitem__(self, idx):
        ...
        # normalization:
        pointcloud, face_info = self.point_transform_norm([pointcloud, face_info])
        ...
        if self.augment:
            ...
            pointcloud, face_info = self.point_transform_aug([pointcloud, face_info])
        ...
        # test
            ...
            return pointcloud.float(),face_info.astype(np.int32)
